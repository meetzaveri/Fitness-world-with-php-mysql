<?php
	...
	if(isset($_POST['btnsave']))
	{
		...
		$userreport= $_POST['userreport'];// user email
		...
		else
		{
			...
			$valid_extensions = array('pdf','jpeg', 'jpg', 'png', 'gif','3gp','mp4','avi','mpeg4','mpeg'); // valid extensions
		...
		if(!isset($errMSG))
		{
			...
			$stmt->bindParam(':ujob',$userreport);
...
<title>Admin Panel Upload Section</title>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
    	<td><label class="control-label">Userreport</label></td>
        <td><input class="form-control" type="text" name="userreport" placeholder="Report" value="<?php echo $userjob; ?>" /></td>
    </tr>
